...
public final class Constants {
  ...
  public static final int JOYSTICK_CONTROLLER_PORT = 5;
  ...
  public static final int LEFT_GEARBOX_MOTOR_NUMBER = 1;
  public static final int RIGHT_GEARBOX_MOTOR_NUMBER = 2;
